...
import type { ExternalBlob as _ExternalBlob, Film as _Film, FilmId as _FilmId, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getFilm(arg0: FilmId): Promise<Film> {
        if (this.processError) {
            try {
                ...
                return from_candid_Film_n8(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async uploadFilm(arg0: string, arg1: string, arg2: ExternalBlob, arg3: ExternalBlob): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.uploadFilm(arg0, arg1, await to_candid_ExternalBlob_n11(this._uploadFile, this._downloadFile, arg2), await to_candid_ExternalBlob_n11(this._uploadFile, this._downloadFile, arg3));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_Film_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Film): Promise<Film> {
...
async function from_candid_record_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        id: value.id,
        title: value.title,
        thumbnail: await from_candid_ExternalBlob_n10(_uploadFile, _downloadFile, value.thumbnail),
        video: await from_candid_ExternalBlob_n10(_uploadFile, _downloadFile, value.video),
